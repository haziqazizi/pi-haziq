...
- Require the external Herdr CLI for default Fabric agent transport. Setup may run `herdr integration install pi`. Do not vendor or edit Herdr's managed `herdr-agent-state.ts` integration.
