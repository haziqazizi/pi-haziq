...
const expectedNames = ["@hono/node-server", "@modelcontextprotocol/sdk", "pi-mcp-adapter"];
...
console.log(
  "production audit: only GHSA-frvp-7c67-39w9 stale metadata remains; installed @hono/node-server@1.19.15 is the patched 1.x release",
);
